...
qinpel.our.soul.arms.addActions([inputUser, inputPass, buttonEnter], (qinEvent) => {
    ...
    if (isActionTrigger()) {
        ...
        qinpel.chief
            .tryEnter(user, pass)
            .then((_) => {
            qinpel.jobbed.statusInfo("Successful entry with user " + user, "{qinpel-app}(ErrCode-000004)");
