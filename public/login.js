...
qinpel.jobbed.statusInfo((0, qinpel_res_1.tr)("You must inform your user and pass to enter."), "{qinpel-app}(ErrCode-000003)");
...
qinpel.our.soul.arms.addActions([inputUser, inputPass, buttonEnter], (qinEvent) => {
    ...
    if (isActionTrigger()) {
        ...
        qinpel.chief
            .tryEnter(user, pass)
            .then((_) => {
            qinpel.jobbed.statusInfo((0, qinpel_res_1.tr)("Successfully entry with user ") + user, "{qinpel-app}(ErrCode-000004)");
            qinpel.jobbed.navigate("./desk.html");
        })
            .catch((err) => {
            qinpel.jobbed.showAlert((0, qinpel_res_1.tr)("Problem on enter: ") + err);
        });
    }
});
...
},{"./qin-arms":3,"./qin-body":4,"./qin-foot":5,"./qin-head":6,"./qin-legs":7,"./qin-skin":8,"./qin-soul":9}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.QinArms = exports.QinPointerCalls = exports.QinWaiters = exports.QinEvent = exports.QinActionKind = void 0;
...
},{"./qin-skin":8}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./qin-body":4}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./qin-skin":8}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./qin-arms":3}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
